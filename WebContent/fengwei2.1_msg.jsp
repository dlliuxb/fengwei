	 ...
	 <div class="row">
	 	...
	 	<div class="col-md-1">
	 		<div id="login" style="float: center;padding-bottom: 16%;margin-top: 75%;">
                <button type="button" id="login"  data-toggle="modal" data-target="#adminLogin" ng-show = "!$scope.admin" >管理员登录</button>
                <button type="button" id="logout" ng-click="$scope.admin = false;" ng-show = "$scope.admin">退出管理界面</button>
            </div>
	 	</div>
	 </div>
</div>
...
<table id="fengweiresults" class="table table-striped table-bordered" style="width:100%" data-widget="datatable"
  ...
  <tbody>
    <tr ng-repeat="fengWeiMiaoShu in fengWeiMiaoShuModel|orderBy:col:desc">
      <td>
        <button class="btn" ng-click="editFengWeiMiaoShu(fengWeiMiaoShu.fengweiId)" ng-show="$scope.admin">
          <span class="glyphicon glyphicon-pencil"></span>编辑
        </button>
        <button class="btn" ng-show="$scope.admin" data-toggle="modal" data-target="#deleteConfirm">
...
<div id="adminForm" ng-show="$scope.admin">
<hr>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<input type="password" ng-model="password" >密码
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" ng-click="preExecDelete(fengWeiMiaoShu.fengweiId)">
					确认
				</button>
			</div>
		</div><!-- /.modal-content -->
