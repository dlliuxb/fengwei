	 ...
	 <div class="row">
	 	...
	 	<div class="col-md-1">
	 		<div id="login" style="float: center;padding-bottom: 16%;margin-top: 75%;">
                <button type="button" ng-click="$scope.admin = true;" ng-show = "!$scope.admin" >管理员登录</button>
                <button type="button" ng-click="$scope.admin = false;" ng-show = "$scope.admin">退出管理界面
            </div>
	 	</div>
	 </div>
</div>
  ...
  <tbody>
    <tr ng-repeat="fengWeiMiaoShu in fengWeiMiaoShuModel|orderBy:col:desc">
      <td>
        ...
        <button class="btn" ng-click="preExecDelete(fengWeiMiaoShu.fengweiId)" ng-show="$scope.admin">
